...
class ewduaspSettings {
	...
	public function set_defaults() {
		...
		$this->defaults = array(
			...
			'styling-email-background-color'		=> '#f6f6f6',
			'styling-email-inner-color'				=> '#ffffff',
			'styling-email-text-color'				=> '#222222',
			'styling-email-button-bg-color'			=> '#348eda',
			'styling-email-button-text-color'		=> '#ffffff',
			'styling-email-background-color'		=> '#f6f6f6',
			'styling-email-background-color'		=> '#f6f6f6',
	...
	public function load_settings_panel() {
		...
		$sap->add_setting(
	      ...
	      'select',
	      array(
	        'id'            => 'admin-appointment-notification',
	        'title'         => __( 'Admin Appointment Notification', 'ultimate-appointment-scheduling' ),
	        'description'   => __( 'What email, if any, should be sent to the administrator when an appointment is booked?', 'ultimate-appointment-scheduling' ), 
	        'blank_option'  => true,
	        'options'       => $this->email_options
	      )
	    );
	    ...
	    $sap->add_setting(
	      ...
	      array(
	        ...
	        'title'         => __( 'Admin Email Address', 'ultimate-appointment-scheduling' ),
	        'description' => __( 'Provide the email address at which you would like to receive the admin email notification chosen in the option above.', 'ultimate-appointment-scheduling' ),
	      )
	    );
	    ...
	    $sap->add_setting(
	      ...
	      'select',
	      array(
	        'id'            => 'service-provider-notification',
	        'title'         => __( 'Service Provider Appointment Notification', 'ultimate-appointment-scheduling' ),
	        'description'   => __( 'What email, if any, should be sent to the service provider when an appointment is booked?', 'ultimate-appointment-scheduling' ), 
	        'blank_option'  => true,
	        'options'       => $this->email_options
	      )
	    );
	...
	public function premium_info( $section_and_perm_type ) {
		...
		$premium_features = '
			...
			<div class="ewd-uasp-dashboard-new-footer-one-buttons">
				<a class="ewd-uasp-dashboard-new-upgrade-button" href="https://www.etoilewebdesign.com/license-payment/?Selected=UASP&Quantity=1&utm_source=uasp_settings&utm_content=' . $section_and_perm_type . '" target="_blank">' . __( 'UPGRADE NOW', 'ultimate-appointment-scheduling' ) . '</a>
			</div>
		';
			...
			case 'emails':
				...
				$content = '
					<div class="ewd-uasp-settings-preview">
						...
						' . preg_replace( '/<div (.*?)</div>/', '', $premium_features ) . '
					</div>
				';
